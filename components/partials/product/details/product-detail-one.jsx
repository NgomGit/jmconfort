            ...
            <div className={ `skel-pro skel-detail ${ adClass }` }></div>
            {
                ...
                <div className={ `product-single-details ${ adClass }` }>
...

                    {
                        // isNav ?
                        false ?
                            <ProductNav prev={ product } next={ product } />
                            : ""
                    }
                    ...
                    <div className="price-box">
                        {
                            product.price == product.sale_price ?
                                <span className="product-price">{ 'FCFA ' + product.price.toFixed( 2 ) }</span>
                                : product.variants?.length > 0 ?
                                    <span className="product-price">{ 'FCFA ' + product.price.toFixed( 2 ) } &ndash; { 'FCFA ' + product.sale_price.toFixed( 2 ) }</span>
                                    : <>
                                        <span className="old-price">{ 'FCFA ' + product.sale_price.toFixed( 2 ) }</span>
                                        <span className="new-price">{ 'FCFA ' + product.price.toFixed( 2 ) }</span>
                                    </>
                        }
                    </div>
                                            ...
                                            <div className="price-box">
                                                {
                                                    variant && variant.id >= 0 ?
                                                        ...
                                                        product.price == product.sale_price ?
                                                            <span className="product-price">{ 'FCFA ' + product.price.toFixed( 2 ) }</span>
                                                            : product.variants?.length > 0 ?
                                                                <span className="product-price">{ 'FCFA ' + product.price.toFixed( 2 ) } &ndash; { '$' + product.sale_price.toFixed( 2 ) }</span>
                                                                :
                                                                <>
                                                                    <span className="old-price">{ 'FCFA ' + product.sale_price.toFixed( 2 ) }</span>
                                                                    <span className="new-price">{ 'FCFA ' + product.price.toFixed( 2 ) }</span>
                                            ...
                                            <div className="price-box product-filtered-price m-0" ref={ setCollapsibleElement }>
                                                {
                                                    variant && variant.id >= 0 && ( variant.price ? variant.sale_price ?
                                                        <>
                                                            <del className="old-price"><span>FCFA { variant.price.toFixed( 2 ) }</span></del>
                                                            <span className="product-price">FCFA { variant && variant.sale_price.toFixed( 2 ) }</span>
                                                        </>
                                                        : <span className="product-price">FCFA { variant && variant.price.toFixed( 2 ) }</span>
                    ...
                    <div className="product-single-share mb-3">
                        <label className="sr-only">Partager:</label>
